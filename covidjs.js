$(document).ready(function() {
    ...
    var jsonObject = jsonResults;
      ...
      jsonObject.Countries.forEach(
        function(item, index) {
         ...
         formatedText += "<div class='dish-ingredients-div'><h3>Total Confirmed Cases: " + item.TotalConfirmed + "<h3></div>";
  ...
  pat=$("#ingredients").val();
    ...
    request.fail(function (jqXHR, textStatus, errorThrown){
        $("#search-results-heading").text("Unable to fetch data");
        $("#results").text("");
    });
  ...
  function setNotFoundMessages() {
    $("#search-results-heading").text("Please enter a country name to continue");
    $("#results").text("");
  }
